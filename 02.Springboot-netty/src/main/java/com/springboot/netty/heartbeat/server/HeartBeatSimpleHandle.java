...
import com.springboot.netty.heartbeat.config.NettySocketHolder;
...
public class HeartBeatSimpleHandle extends SimpleChannelInboundHandler<CustomProtocol> {
    ...
    /** logger. */
    private Logger logger = LoggerFactory.getLogger(HeartBeatSimpleHandle.class);
    ...
    protected void channelRead0(ChannelHandlerContext ctx, CustomProtocol msg) throws Exception {
        ...
        logger.info("收到客户端的信息,{}",msg.toString());
